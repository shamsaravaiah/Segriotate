...
4. /detect    -- Auto-Detect full-image seg (YOLO-seg, FastSAM, or MobileSAM grid)
5. /segment   -- click-to-segment fallback (.pt or .engine: FastSAM, MobileSAM, …)
6. /label     -- read/write YOLO .txt files in labels/
7. /project/label-stats -- mask/image counts per class in the labels folder
8. /project/split-dataset -- copy train/val/test (+ CSV) from the open folders
9. /project/train/* -- start/stop/poll training jobs
10. /media     -- serve images from the chosen images folder
